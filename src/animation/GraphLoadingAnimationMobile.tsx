...
const GraphLoadingAnimation: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-end bg-black bg-opacity-90 fixed top-0 left-0 z-50">
      {/* Main SVG with grid and graph */}
      <div className="relative w-full h-full">
        {/* Added responsive padding-top */}
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 150 260"
        ...
        >
          ...
          {[...Array(20)].map((_, i) => (
            <line
              ...
              y1="0"
              x2={(i + 1) * 10}
              y2="300" /* Align with viewBox height */
              stroke="#404040"
              strokeWidth="0.25"
            />
          ))}
          ...
          {/* Graph line */}
          <path
            d="M0,210 L20,200 L40,180 L80,150 L120,170 L160,140 L200,130"
            fill="none"
            stroke="#f59e0b"
            strokeWidth="1"
          />

          {/* Step animation (downward 40 grids) */}
          <circle
            cx="0"
            cy="210" // Start the circle at the first Y value (210)
            r="2.5"
            fill="#f59e0b"
          ...
          <path
            d="M0,210 L20,200 L40,180 L80,150 L120,170 L160,140 L200,130 L200,240 L0,240 Z"
      ...
      <div className="absolute top-8 left-8 sm:top-4 sm:left-4">
        <svg
          ...
          height="70"
          viewBox="0 0 32 32"
          className="rotate-90 sm:w-16 sm:h-16"
        >
          <circle
            cx="16"
            cy="16"
